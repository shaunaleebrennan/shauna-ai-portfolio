...
The hero also includes a downloadable CV and a continuously scrolling AI toolkit featuring GitHub, GitHub Copilot, MongoDB Atlas, Render, ZoomMate, ChatGPT-Live, Claude, Figma, Codex, Claude Code, Lovable, n8n, ElevenLabs, My Notes by Zoom, Gemini, OpenAI, Replit, Clozd, HQ Agent, and hiresteve.ai.
