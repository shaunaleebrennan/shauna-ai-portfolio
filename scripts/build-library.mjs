...
const githubTarget = href => {
  ...
  if (href.startsWith('index.html') || href.startsWith('it-pressure-test/')) return site + href;
  return '../' + href;
};
