...
const copy = {
 general:['Make everyday work easier to navigate.','Workvivo HQ brings communication, knowledge and employee services into a shared experience. Where the journey needs an answer or a supported action, HQ Agent can be part of that experience.'],
